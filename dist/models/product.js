...
var productStore = /** @class */ (function () {
    ...
    productStore.prototype.create = function (product_name, price, category) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Cannot add the product ".concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    productStore.prototype.topFive = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'SELECT product_id FROM order_product GROUP BY product_id order by SUM(quantity) DESC LIMIT 5;';
                        return [4 /*yield*/, conn.query(sql)];
                    case 2:
                        result = _a.sent();
                        conn.release();
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Cannot get most 5 popular products: ".concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    productStore.prototype.byCategory = function (category) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Cannot get this category: ".concat(err_5, "."));
                    case 4: return [2 /*return*/];
                }
            });
        });
